...
export default class TempEditCard extends SmartView {
  constructor(task = BLANK_TASK) {
    super();
    this._data = TempEditCard.parseTaskToData(task);
  ...
  reset(task) {
    this.updateData(
        TempEditCard.parseTaskToData(task)
    );
  }

  getTemplate() {
    return getTempEditCard(this._data);
  }
  ...
  _formSubmitHandler(evt) {
    evt.preventDefault();
    this._callback.formSubmit(TempEditCard.parseDataToTask(this._data));
  }
